...
class TimeSimulationConfig:
    ...
    off_peak_activity_multiplier: float = (
        0.05  # Extremely low activity in early morning
    )
...
class SimulationConfigGenerator:
    ...
    def generate_config(
        ...
        reasoning_parts.append(
            f"Agent config: successfully generated {len(all_agent_configs)}"
        )
...
responses.
For metric requests, do NOT use undirected wording like "does anyone" or
"team question". Route requests to a specific owner with an @mention.
Examples of data-oriented posts:
- "@FinanceOps can you share the latest Q1 EMEA revenue actuals for the board deck?"
- "@RetentionAnalytics I'm seeing conflicting churn signals. Please pull the current churn actuals by region."
- "@PaidMediaLead what's our current marketing spend vs. ROAS for Samba paid campaigns this month?"
